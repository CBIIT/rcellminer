test_that("selectCorrelatedRows2() returns correct information", {
	...
	expect_identical(
		...
		selectCorrelatedRows2(Y, XList, corThreshold, useAbsCor = TRUE)
	)
	...
	expect_identical(
		...
		selectCorrelatedRows2(Y, XList, corThreshold, useAbsCor = FALSE)
	)
